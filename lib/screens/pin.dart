...
class PinPage extends StatefulWidget {
  ...
  const PinPage({Key? key, required this.changingPin}) : super(key: key);
...
class _PinPageState extends State<PinPage> {
  ...
  Text getText() {
    if (widget.changingPin) {
      return Text(AppLocalizations.of(context)!.change_pin);
    }
    return Text(AppLocalizations.of(context)!.enter_pin);
  }

  @override
  Widget build(BuildContext context) {
    final length = 4;
    const borderColor = const Color.fromARGB(148, 112, 14, 46);
      ...
      child: Scaffold(
          body: Center(
              child: Column(
                  ...
                  children: [
            Padding(padding: EdgeInsets.only(bottom: 10), child: getText()),
            Pinput(
              length: length,
              ...
              validator: (pin) {
                ...
                return AppLocalizations.of(context)!.incorrect_pin;
              },
